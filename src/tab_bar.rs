...
// /// Creates Tab bar widget for basic webview
// pub fn tab_bar_basic<Message: 'static + Clone>(
//     tabs: Vec<(TabIdType, String)>,
//     active_tab: TabIdType,
//     on_tab_select: Box<dyn Fn(TabIdType) -> Message>,
//     on_close_tab: Box<dyn Fn(TabIdType) -> Message>,
//     on_create_tab: Message,
// ) -> Element<'static, Message> {
//     let active_tab = tabs
//         .iter()
//         .find(|(id_type, _)| match id_type {
//             TabIdType::index(index) => index == ,
//             TabIdType::TabId(id) => id == active_tab,
//         })
